...
## Project Structure
    ...
    ├── testapiautosetting_127046  # Django project configurations
...
1. Clone this repo and `cd testapiautosetting_127046`
...
2. Clone this repo and `cd testapiautosetting_127046`
